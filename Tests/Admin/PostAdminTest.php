...
class PostAdminTest extends WebTestCase
{
    public function testEmptyPostsListForAdmin()
    {
        ...
        $crawler = $this->fetchCrawler($this->getUrl('admin_stfalcon_blog_post_list', array()), 'GET', true, true);
    ...
    public function testCreateNewPost()
    {
        ...
        $crawler = $client->request('GET', $this->getUrl('admin_stfalcon_blog_post_create', array()));
        ...
        $this->assertTrue($client->getResponse()->isRedirect($this->getUrl('admin_stfalcon_blog_post_edit', array('id' => 1) )));
    ...
    public function testEditPost()
    {
        ...
        $crawler = $client->request('GET', $this->getUrl('admin_stfalcon_blog_post_edit', array('id' => $post->getId())));
        ...
        $this->assertTrue($client->getResponse()->isRedirect($this->getUrl('admin_stfalcon_blog_post_edit', array('id' => $post->getId()) )));
    ...
    public function testDeletePost()
    {
        ...
        // delete post
        $crawler = $client->request('POST', $this->getUrl('admin_stfalcon_blog_post_delete', array('id' => $post->getId())), array('_method' => 'DELETE'));
